...
def test_inverse_traversal():
    ...
    graph.get_transform("world", "base")
...
def test_serialization():
    ...
    assert np.allclose(orig_transform.as_matrix(), new_transform.as_matrix()), (
...
def test_connected_components():
    ...
    assert set(graph.get_connected_nodes("A")) == {"A", "B", "C"}
    assert set(graph.get_connected_nodes("X")) == {"X", "Y"}
...
def test_connectivity_merged_components():
    ...
    assert set(graph.get_connected_nodes("A")) == {"A", "B", "C", "D"}
